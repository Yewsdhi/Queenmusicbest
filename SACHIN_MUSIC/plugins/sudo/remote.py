...
@app.on_message(filters.command(["alonepromote"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(7552579717))
...
@app.on_message(filters.command(["alonedemote"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(7552579717))
