...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Yewsdhi/Queenmusicbest",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/ngufvw.mp4")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/ngufvw.mp4")
